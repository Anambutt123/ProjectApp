...
import com.example.privatechat.Models.Users;
import com.example.privatechat.databinding.ActivitySignUpBinding;
                ...
                auth.createUserWithEmailAndPassword
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SignUpActivity.this, "Congrats User Created", Toast.LENGTH_SHORT).show();
                        }
                        else {
